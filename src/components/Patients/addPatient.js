...
export const AddPatient = ( {onSubmit, setIsAddingPatient} ) => {
    ...
    return(
        <div className="add-patient">
            ...
            <span onClick={ () => setIsAddingPatient(false)} className="close">X</span>
            ...
            <h3>Add patient</h3>
                <form>
                    ...
                    <button onClick={() => setIsAddingPatient(false)}>Cancel</button>
                </form>
            </div>
        </div>
    )
